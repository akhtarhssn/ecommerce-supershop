            ...
            {activeTab === "profile" && (
              <div className="bg-white rounded-2xl border border-[#D1D5DB] p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Button variant="outline" size="sm" className="border-[#6366F1] text-[#6366F1] gap-1.5">
                ...
                <div className="flex items-center gap-5 mb-7">
                  ...
                  <div>
                    ...
                    <Badge className="bg-[#EEF2FF] text-[#6366F1] border-0 mt-1 text-xs">
                      Regular Customer
                    </Badge>
                  </div>
                </div>
                <div className="grid sm:grid-cols-2 gap-5">
                  {[
                    ...
                    <div key={field.id} className="space-y-1.5">
                      ...
                      <Input defaultValue={field.value} className="border-[#D1D5DB]" readOnly />
                    </div>
                  ))}
                </div>
                <div className="mt-5 space-y-1.5">
                  <Label className="text-sm font-medium text-gray-700">Default Address</Label>
                  <Input defaultValue="123 Oak St, New York, NY 10001" className="border-[#D1D5DB]" readOnly />
                </div>
              </div>
            )}
